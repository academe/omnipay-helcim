...
class HostedPagesCompleteAuthorizeRequest extends AbstractRequest
{
    ...
    public function getData()
    {
        ...
        // with passes through the user's browser before the application ever sees it.

        // Reading this:
        // http://stackoverflow.com/questions/20888243/omnipay-is-there-a-convention-about-using-transactionid-vs-transactionreference
        // We will map:
        // * OmniPay transactionId to Helcim orderId (generated by the application)
        // * OmniPay transactionReference to Helcim transactionId (generated by Helcom)
        ...
        // Some additional fields will be posted, and will not be stored anywhere.
